...
<div
    ...
    <div class="dark:text-white">
        ...
        @foreach($listItems as $listItem)
            <div class="flex sm:justify-between mt-6">
                ...
                <form action="{{route('markDone',$listItem->id)}}" method="post" accept-charset="UTF-8">
                    {{csrf_field()}}
                    <button class="px-6" style="max-height: 30px; color: darkred; border: 1px solid darkred">Done
                    </button>
                </form>
            </div>
        @endforeach
        ...
        <form action="{{route('saveItem')}}" method="post" accept-charset="UTF-8">
            ...
            <br>
            <input type="text" name="listItem" class="text-gray-900">
            <button class="btn" type="submit" style="max-height: 30px; color: aqua; border: 1px solid aqua">add</button>
